<p align="center">
  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="z-index:1;position:relative" width="854" height="300" viewBox="0 0 854 300">
    ...
    <g transform="translate(427, 150) scale(1, 1) translate(-427, -150)">
      <path d="" fill="url(#linear)" opacity="0.4" transform="scale (-1, 1)" transform-origin="center">
    ...
    <text text-anchor="middle" alignment-baseline="middle" x="50%" y="44%" class="text" style="fill:#189ad3;" stroke="#adff00" stroke-width="4">¡Prose And Pages!</text>
                <text text-anchor="middle" alignment-baseline="middle" x="50%" y="60%" class="desc" style="fill:#189ad3;">THE BEST WEBSITE EVER MADE</text> 
            </svg>
</p>
